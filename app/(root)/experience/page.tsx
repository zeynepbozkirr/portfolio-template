...
export const metadata: Metadata = {
  title: pagesConfigTr.experience.metadata.title,
  description: pagesConfigTr.experience.metadata.description,
};
...
export default function ExperiencePage() {
  return (
    <PageContainer
      title={pagesConfigTr.experience.title}
      description={pagesConfigTr.experience.description}
    >
